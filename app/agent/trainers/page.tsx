...
export default async function AgentTrainersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[#6B8F9E] mt-1">{agent.trainers.length} trainer{agent.trainers.length !== 1 ? 's' : ''} registered</p>
      </div>
