...
const navItems = [
  ...
  { label: 'Trainers',  href: '/institution/trainers', icon: Users },
]
    ...
    <div className="min-h-screen bg-[#F8F7F4] flex">
      ...
      `}>
        <div className="px-5 py-5 border-b border-white/10 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[8px] tracking-[0.2em] text-[#c71430] uppercase">Institution Portal</p>
            </div>
          </Link>
        ...
        <nav className="flex-1 py-2 overflow-y-auto">
          {navItems.map(item => {
            const active = item.href === '/institution'
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden bg-white border-b border-stone-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-30">
          ...
          <p className="text-[#022269] text-sm font-semibold">Institution Portal</p>
        </header>
