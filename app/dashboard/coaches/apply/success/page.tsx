...
export default function ApplySuccessPage() {
  return (
    <div className="max-w-lg mx-auto text-center py-20">
      <div className="w-20 h-20 rounded-full bg-green-50 border border-green-100 flex items-center justify-center text-3xl mx-auto mb-6">
        ✓
      </div>
      <h1 className="font-display text-3xl text-[#0A1628] font-light mb-4">
      ...
      <div className="bg-white rounded-2xl border border-stone-100 p-6 text-left mb-8 space-y-3">
        {[
      ...
      <Link
        href="/dashboard"
        className="inline-flex items-center gap-2 bg-[#0A1628] hover:bg-[#1A2B4A] text-white text-sm font-medium px-6 py-3 rounded-full transition-colors"
      >
        Back to Dashboard →
      </Link>
    </div>
