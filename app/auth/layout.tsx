...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#022269] flex">
      {/* Left panel — branding */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_30%_50%,#011344,#020f3a)]" />
        <div className="absolute inset-0"
          style={{ backgroundImage: 'linear-gradient(#c7143008 1px,transparent 1px),linear-gradient(90deg,#c7143008 1px,transparent 1px)', backgroundSize: '60px 60px' }}
        />
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[#c71430] text-[9px] tracking-[0.2em] uppercase">Learning & Training</p>
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="mt-10 flex flex-col gap-3">
            {[
              ...
              { name: 'Career for Everyone', color: '#c71430', desc: 'Career development' },
              { name: 'The Business Clock', color: '#2C4A3E', desc: 'Entrepreneurship' },
            ].map(p => (
              <div key={p.name} className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 rounded-none" style={{ background: p.color }} />
