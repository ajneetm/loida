  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] flex">
      ...
      <aside className={`
        ...
        lg:translate-x-0 lg:static lg:flex lg:min-h-screen lg:sticky lg:top-0 lg:self-stretch
      `}>
        {/* Logo */}
        <div className="px-5 py-5 border-b border-white/10 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[8px] tracking-[0.2em] text-[#c71430] uppercase">Trainer Portal</p>
            </div>
          </Link>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden bg-white border-b border-stone-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-30">
          ...
          <p className="text-[#022269] text-sm font-semibold">Trainer Portal</p>
        </header>
